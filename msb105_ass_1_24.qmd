...
Unlike R Markdown, Quarto does not rely on or require R.
It was designed to be a multilingual tool from the start, supporting languages such as R, Python, JavaScript, and Julia, with the goal of being adaptable to future programming languages that may emerge [@zotero-84].
